...
const InboxHeader:React.FC<headerProps> = ({currColor}) => {
    ...
    <div className={`w-8 h-8 ${ currColor? 'bg-[#262B]':'bg-[#e1e7ee]' } rounded flex justify-between items-center`}>
        <RotateCw className='w-5 h-5 ml-3.5 cursor-pointer' onClick={handleReset}/>
    </div>
    </>
